...
var simplemaps_countrymap_mapinfo = {
  ...
  default_labels: {},
  proj_coordinates: [
    { x: 90.9, y: 738.5, lat: 4.752569, lng: 3.271025 },
    { x: 545.5, y: 445.3, lat: 8.59582, lng: 9.270452 },
    { x: 909.1, y: 74.4, lat: 13.399884, lng: 14.069993 },
  ],
};
  ...
  function h() {
    ...
    function tN() {
      if (p) {
        ...
        var e = m ? "20px" : "5px";
        (tL.style.cssText =
          "overflow: visible !important; clip-path: none !important; display:none !important; opacity:0 !important; transform: none !important; visibility: visible !important; z-index: 1 !important; right: 5px !important; bottom:" +
          e +
    ...
    function tD() {
      eq.hide(), ed.style.setProperty("display", "block");
    }
    function tR() {
