...
const SponsorsPartnersSection = () => {
  ...
  const getConcurrentPosition = (index: number, total: number, offset: number = 0) => {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto px-4">
            We are proud to work with leading organizations committed to Northern Nigeria's economic transformation.
          </p>
        </div>
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-40 right-20 w-12 sm:w-24 h-12 sm:h-24 bg-nigeria-green/5 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
          <div className="absolute bottom-40 left-1/4 w-10 sm:w-20 h-10 sm:h-20 bg-nigeria-green/5 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
        </div>
      </div>
    </section>
  );
